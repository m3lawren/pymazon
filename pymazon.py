...
def main():
	...
	request = 'http://webservices.amazon.com/onca/xml?Service=AWSECommerceService&AWSAccessKeyId=' + key + '&Operation=ItemLookup&ResponseGroup=ItemAttributes&ItemId=0618669078'
